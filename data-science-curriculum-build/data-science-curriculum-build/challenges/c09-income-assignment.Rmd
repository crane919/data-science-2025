...
-   Document your observations here.
    -   2 person households appear to have generally lower incomes than the other categories.
    -   Generally across counties their appears to be the trend that 2-person families are lowest, then 3-person, then 4, 5, and 6 are after but could be in any order.
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   No, because all of the ranges overlap, and all the medians are close to each other.
...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   There is less error, the bigger the population size the smaller the standard error
    -   Trends become more prominent with a large data size, in smaller populations outliers have a bigger impact.
-   What does this *overall* trend tell you about the relative ease of studying small vs large counties?
    -   Large counties are easier to estimate, since there will be most likely be a smaller margin of error
...
-   2-person families are the most common in the US, as the median percentage across all counties is just above 50%
-   Then there is a decrease in percentage of the population as the number of people in a family goes up
    -   This is likely due to the increase in effort and cost per person in a family, especially if we assume that each additional person beyond the two is a child or elderly person who requires care.
